...
defineBindBlock("launchers", function()
	...
	bind(modBind("M"), uwsm.raw([[hyprshutdown --post-cmd "$HOME/.config/hypr/scripts/hypr-session-exit"]]))
...
defineBindBlock("media", function()
	...
	bind("XF86AudioNext", uwsm.raw("playerctl --player=" .. programs.music_mpris .. " next"), { locked = true })
	bind("XF86AudioPause", uwsm.raw("playerctl --player=" .. programs.music_mpris .. " play-pause"), { locked = true })
	bind("XF86AudioPlay", uwsm.raw("playerctl --player=" .. programs.music_mpris .. " play-pause"), { locked = true })
	bind("XF86AudioPrev", uwsm.raw("playerctl --player=" .. programs.music_mpris .. " previous"), { locked = true })
end)
